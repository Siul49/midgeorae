...
*   **시민 직업 종류**:
    ...
    | :--- | :--- | :--- |
    | **개발자 (Developer)** | 보유한 모든 물건의 카테고리가 '전자기기(Electronics)'여야 함 (최소 1개 이상 보유). | 2,000,000원 (첫 손패 감가 차감 전) |
    | **모델 (Model)** | 보유한 모든 물건의 카테고리가 '패션잡화(Fashion)'여야 함 (최소 1개 이상 보유). | 2,000,000원 (첫 손패 감가 차감 전) |
    | **주부 (Housewife)** | 보유한 모든 물건의 카테고리가 '생활용품(Living)'여야 함 (최소 1개 이상 보유). | 2,000,000원 (첫 손패 감가 차감 전) |
    | **벽돌 수집가 (Brick Collector)** | 게임 종료 시 '벽돌 카드'를 2개 이상 보유해야 함. | 2,000,000원 (첫 손패 감가 차감 전) |
...
| **기부천사** | `donation` | 이웃 중 1명을 지목해 그들의 손패 중 무작위 물품 1장을 일방적으로 기부(강탈)받아 옵니다. | 1 (약 7.1%) |
