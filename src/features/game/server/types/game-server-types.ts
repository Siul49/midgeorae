import type { ItemCategory, ItemCondition } from "../../types/game-core-types";
...
export interface CitizenMission {
  id: string; // 'inspector_trade' | 'negotiator_nego' | 'reporter_review' | 'cool_deal' | 'discount_register' | 'receive_like'
  title: string;
  description: string;
  progress: number;
  target: number;
...
export interface ServerPlayer {
  ...
  citizenMissions?: CitizenMission[];
}
...
export type RoomAction =
  ...
  | { type: "chooseDealCard"; choice: DealCardChoice; scam?: boolean }
